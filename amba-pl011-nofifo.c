...
/*
 *  Driver for AMBA serial ports with disable FIFO functionality.
 *
...
static int __init pl011_fifos_init(void)
{
	printk(KERN_INFO "Serial: AMBA PL011 UART driver (disabled FIFO)\n");
...
static void __exit pl011_fifos_exit(void)
{
 ...
 */
arch_initcall(pl011_fifos_init);
module_exit(pl011_fifos_exit);

MODULE_AUTHOR("ARM Ltd/Deep Blue Solutions Ltd");
MODULE_AUTHOR("Krzysztof 'Itachi' Bak <kernel@itachi.pl>");
MODULE_DESCRIPTION("ARM AMBA serial port driver (disabled FIFO)");
MODULE_LICENSE("GPL");
